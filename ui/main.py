...
class mainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setup_aria2c()
        # 设置窗口标题和大小
        self.setWindowTitle(self.tr("R.E.P.O.启动器"))
        ...
        self.button_close.setText(self.tr("结束"))
        ...
        self.showAction.setText(self.tr("隐藏"))
        ...
        self.channelMenu.setTitle(self.tr("切换更新通道"))
        self.channelActions = {}
        if self.supported_update_channel:
            for channel, name, enable in self.supported_update_channel:
                ...
                self.channelActions[channel].setText(self.tr(name))
        ...
        self.chkAction.setText(self.tr("验证完整性"))
        ...
        self.updateAction.setText(self.tr("检查更新"))
        ...
        self.aboutAction.setText(self.tr("关于"))
        ...
        self.quitAction.setText(self.tr("退出"))
        ...
        self.statusBar.showMessage(self.tr("程序准备中"))
    ...
    def onUpdateComplete(self, e, t, k: str):
        if e:
            ...
            # os.system("start "f'"{self.tr("R.E.P.O.启动器 | 更新")}"'" update.exe -n "f"{k.replace('_update.data', '')}")
            subprocess.Popen(
                f'start "{self.tr("R.E.P.O.启动器 | 更新")}" update.exe -n {k.replace("_update.data", "")}',
                shell=True,
    ...
    def show_tray_menu(self):
        if self.isHidden():
            ...
            self.showAction.setText(self.tr("显示"))
            self.hide()
    ...
    def buttonStart_onClick(self):
        ...
        self.startAction.setText(self.tr("准备启动..."))
        net = network_check()
    ...
    def buttonClose_onClick(self):
        if QMessageBox.question(self, self.tr("关闭"), self.tr("确定要强制结束游戏吗？"), QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No) == QMessageBox.StandardButton.Yes:
    ...
    def buttonAbout_onClick(self):
        QMessageBox.information(self, self.tr("关于"), f'{self.tr("版本: ")}{ver}')
